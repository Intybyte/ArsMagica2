...
public class BytecodeTransformers implements IClassTransformer{
	...
	public byte[] transform(String name, String transformedName, byte[] bytes){
		boolean is_obfuscated = !AM2EnviromentData.isDevEnvironment;
		
		if (transformedName.equals("am2.armor.ItemMageHood") && AM2EnviromentData.foundThaumcraft){
		...
		*/
		...
		}else if (transformedName.equals("net.minecraft.potion.PotionEffect") && !AM2EnviromentData.foundDragonAPI){
		...
		}else if (transformedName.equals("net.minecraft.network.play.server.S1DPacketEntityEffect") && !AM2EnviromentData.foundDragonAPI){
			LogHelper.info("Core: Altering definition of " + transformedName + ", " + (is_obfuscated ? " (obfuscated)" : "(not obfuscated)"));
			String passedname = name.replace(".", "/");
			bytes = alterS1DPacketEntityEffect(bytes, is_obfuscated, passedname);
		}else if (transformedName.equals("net.minecraft.client.network.NetHandlerPlayClient") && !AM2EnviromentData.foundDragonAPI){
		  LogHelper.info("Core: Altering definition of " + transformedName + ", " + (is_obfuscated ? " (obfuscated)" : "(not obfuscated)"));
		  bytes = alterNetHandlerPlayClient(bytes, is_obfuscated);
		}else if (transformedName.equals("net.minecraft.network.play.server.S1EPacketRemoveEntityEffect") && !AM2EnviromentData.foundDragonAPI){
			LogHelper.info("Core: Altering definition of " + transformedName + ", " + (is_obfuscated ? " (obfuscated)" : "(not obfuscated)"));
