...
public interface IFlickerRegistry{
	 ...
	 * @param mask      The bit mask representing the flicker combination.  These are ORed affinity masks.  @see am2.common.api.spell.enums.Affinity.getMask for specific mask flags (flickers represent an affinity)
